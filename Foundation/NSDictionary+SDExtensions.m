...
- (NSInteger)intForKeyPath:(NSString *)key { return [self integerForKeyPath:key]; }
...
- (NSUInteger)unsignedIntForKeyPath:(NSString *)key { return [self unsignedIntegerForKeyPath:key]; }
