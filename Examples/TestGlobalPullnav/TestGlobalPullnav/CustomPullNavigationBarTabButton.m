//
//  CustomPullNavigationBarTabButton.m
//  ios-shared
//
...
@implementation CustomPullNavigationBarTabButton
...
- (void)drawRect:(CGRect)rect
{
    if(!self.tuckedTab)
    {
        ...
        //// Color Declarations
        UIColor* backgroundColor = [UIColor colorWithRed: 0.614 green: 0.116 blue: 0.251 alpha: 1];
