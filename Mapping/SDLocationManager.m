...
- (void)timeoutHandler
{
	...
	if (self.location)
	{
        ...
        [delegates callSelector:@selector(locationManager:didUpdateToLocation:fromLocation:) argumentAddresses:(__bridge void *)(self), location, location, NULL];
	...
	else
	{
        ...
        [delegates callSelector:@selector(locationManager:didFailWithError:) argumentAddresses:(__bridge void *)(self), error, NULL];
...
- (void)locationManager:(CLLocationManager *)manager didUpdateToLocation:(CLLocation *)newLocation fromLocation:(CLLocation *)oldLocation
{
	...
	if ([newLocation.timestamp timeIntervalSinceDate:timestamp] < 0)
	{
        ...
        [delegates callSelector:@selector(locationManager:didUpdateToInaccurateLocation:fromLocation:) argumentAddresses:(__bridge void *)(self), newLocation, oldLocation, NULL];
    ...
    [delegates callSelector:_cmd argumentAddresses:(__bridge void *)(self), newLocation, oldLocation, NULL];
}
...
- (void)locationManager:(CLLocationManager *)manager didUpdateHeading:(CLHeading *)newHeading
{
    ...
    [delegates callSelector:_cmd argumentAddresses:(__bridge void *)(self), newHeading, NULL];
...
- (void)locationManager:(CLLocationManager *)manager didFailWithError:(NSError *)error
{
	...
	{
        [delegates callSelector:_cmd argumentAddresses:(__bridge void *)(self), error, NULL];
		//if (delegate && [delegate respondsToSelector:_cmd])
...
{
    [delegates callSelector:_cmd argumentAddresses:(__bridge void *)(self), region, NULL];
	//if (delegate && [delegate respondsToSelector:_cmd])
...
{
    [delegates callSelector:_cmd argumentAddresses:(__bridge void *)(self), region, error, NULL];
	//if (delegate && [delegate respondsToSelector:_cmd])
